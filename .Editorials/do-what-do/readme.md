...
~~~ markdown
这里，「现实的外部」即指「现实」这个范畴，它的外部，即指「非现实」。

也同样，任何自己或谁人曾经有在「非现实」中生活过的说法或者想法，也全都是不切实际的幻想。

但这些幻想的存在本身，也是「现实」之**中**的一部分。这也就是下文「现实的外部并不是自在自在存在的，而是出自于现实的自为」所传达的。
~~~
...
~~~ markdown
凝视是确实存在的。但，毕竟已经避世，所以，就算存在，那也并不是通过观察确证到的，而是根据旧有的经验所做出的想象——这当然要算作是想象。

而「想象」一词也一样，是对「这确实是真的避世」的强调。
~~~
...
> 这种对于知识的整体性批判将会是一个完整的体系。我将在未来的视频中与精通不同领域的相关从业者对谈，也欢迎观众朋友们私信参与。对于知识的整体批判意识将在这里萌发，也将只能以这种形式开花结果。

我为了在写成文字后，避免因此会更容易产生的错会，而改变了记录文本中该部分内容的语序。
~~~
