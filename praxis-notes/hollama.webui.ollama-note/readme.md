[src/gh]: https://github.com/fmaclen/hollama.git "(MIT) (Languages: TypeScript 51.3%, Svelte 39.5%, JavaScript 4.9%, CSS 3.4%, Other 0.9%) A minimal web-UI for talking to Ollama servers // 一个超小的 WEB 用户界面用来与 Ollama 服务对话"
