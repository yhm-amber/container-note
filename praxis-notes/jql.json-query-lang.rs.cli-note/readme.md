...
[src/gh]: https://github.com/yamafaktory/jql.git "(Apache-2.0, MIT) (Languages: Rust 97.9%, Shell 1.7%, Just 0.4%) A JSON Query Language CLI tool // JSON 查询语言 CLI 工具 /// jql is a JSON Query Language tool built with Rust 🦀. // jql 是一个使用 Rust 🦀 构建的 JSON 查询语言工具。 /// Pronounce it as jackal 🐺. // 发音为豺狼 🐺。 /// 📜 Philosophy // 📜 哲学 /// - ⚡Be fast // ⚡要快 /// - 🪶 Stay lightweight // 🪶 保持轻量 /// - 🎮 Keep its features as simple as possible // 🎮 使其功能尽可能简单 /// - 🧠 Avoid redundancy // 🧠 避免冗余 /// - 💡 Provide meaningful error messages // 💡 提供有意义的错误消息 /// - 🍰 Eat JSON as input, process, output JSON back // 🍰 将 JSON 作为输入，处理，输出 JSON"
