[src/gh]: https://github.com/kubernetes-sigs/kwok.git "(Apache-2.0) (Languages: Go 77.6%, Shell 19.1%, Smarty 1.8%, Makefile 0.9%, Dockerfile 0.3%, HTML 0.2%, SCSS 0.1%) Kubernetes WithOut Kubelet - Simulates thousands of Nodes and Clusters."
...
[gh]: https://sigs.k8s.io/kwok/ "(这个地址目前就是链接到上面的 gh 的地址。以及，这个项目目前还不支持 podman ，所以等等吧。)"
